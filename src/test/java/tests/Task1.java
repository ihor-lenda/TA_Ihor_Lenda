...
public class Task1 {
    ...
    public void checkHeadlineArticleTitle() {
        ...
        assertEquals(headlineArticleTitle, "Protesters defy heavy security in Belarus");
    }
    ...
    public void checkSecondaryArticlesTitles() {
        ...
        assertEquals(secondaryArticlesTitlesStrings, expectedTitles);
    ...
    public void searchHeadlineArticleCategory() {
        ...
        assertEquals(headlineArticleTitle, "Cities of Europe");
